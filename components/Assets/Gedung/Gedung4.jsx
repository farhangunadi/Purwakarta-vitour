...
Command: npx gltfjsx@6.1.4 ./public/models/gedung4.glb
*/

import React, { useRef } from "react";
import { useGLTF } from "@react-three/drei";

export function Gedung4(props) {
  const { nodes, materials } = useGLTF("./models/gedung4.glb");
  return (
    <group
      {...props}
      dispose={null}
    ...
    >
      ...
      <group position={[-3.82, 0, 0]} scale={[1.89, 2.39, 1.89]}>
        <mesh
...
useGLTF.preload("./models/gedung4.glb");
